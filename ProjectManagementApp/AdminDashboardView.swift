...
struct AdminDashboardView: View {
    ...
    // Panel Management
    @State private var currentPanel: PanelType = .admin
    ...
    enum MenuItem: String, CaseIterable {
        ...
        var iconColor: Color {
            ...
            case .manageResources: return .purple
            case .manageClients: return .purple
            case .manageProjects: return .purple
            case .taskManagement: return .purple
            case .knowledgeManagement: return .purple
            case .expenses: return .purple
            case .reports: return .purple
            case .minutesOfMeeting: return .purple
            case .calendar: return .purple
            case .leadManagement: return .purple
        ...
        ScrollView {
            VStack(spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    Text("Welcome, \(authService.currentUser?.name ?? "Admin")!")
                        .font(.title)
                        .fontWeight(.bold)
